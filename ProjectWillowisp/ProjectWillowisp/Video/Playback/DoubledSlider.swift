...
public final class DoubledSlider: UIControl {
    ...
    private lazy var leftThumb = UIImageView(image: UIImage(systemName: "circle.fill"))
    private lazy var rightThumb = UIImageView(image: UIImage(systemName: "circle.fill"))
    ...
    private func setupThumb() {
        ...
        leftThumb.tintColor = .primary
        rightThumb.tintColor = .primary
    ...
    private(set) var minimumValueNow: Float = .zero
    private(set) var maximumValueNow: Float = .zero
